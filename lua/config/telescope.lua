...
vim.keymap.set("n", "fs", my_grep_string, default_options)
vim.keymap.set("n", "ft", my_live_grep, default_options)
vim.keymap.set("n", "fr", my_lsp_references, default_options)
